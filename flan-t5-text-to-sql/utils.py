...
def read_msqa(path):
    ...
    for sample in dataset:
        ...
        dataset_dict['question'].append(' '.join(question))
        dataset_dict['context'].append(context_char)
        dataset_dict['answers'].append(answers)
        # dataset_dict['answers_idx'].append(answers_idx_char)
    dataset_load=Dataset.from_dict(dataset_dict)
    # return dataset_new
    return dataset_load
